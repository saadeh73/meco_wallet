...
const resources = {
  ar: {
    translation: {
      ...
      limit: 'محدد',
      quote_currency: 'عملة التسعير',
      available_balance: 'الرصيد المتاح',
      select_quote_currency: 'اختر عملة التسعير',
      no_wallet: 'لا توجد محفظة متصلة',
      limit_order_unavailable_msg: 'خدمة الأوامر المحددة غير متاحة حالياً. هل تريد التنفيذ بسعر السوق الحالي؟',
      limit_price: 'السعر المحدد',
      below_market: 'أقل من سعر السوق',
      above_market: 'أعلى من سعر السوق',
      place_limit_order: 'تسجيل أمر محدد',
      limit_order_placed: 'تم تسجيل الأمر بنجاح',
      open_orders: 'الأوامر المفتوحة',
      cancel_order: 'إلغاء الأمر',
      cancel_order_confirm: 'هل تريد إلغاء هذا الأمر؟',
      order_cancelled: 'تم إلغاء الأمر',
      yes_cancel: 'نعم، إلغاء',
      no: 'لا',
      at_price: 'بسعر',
      enter_limit_price: 'أدخل السعر المحدد',
      confirm_buy: 'تأكيد الشراء',
      confirm_sell: 'تأكيد البيع',
      ...
      no_history_yet: "لا يوجد سجل تصفح بعد",
      history_hint: "ستظهر هنا المواقع التي تزورها",
      category_staking: "تخزين",
      category_defi: "DeFi",
      category_trading: "تداول",
      category_pools: "مجمعات",
      explore_web3: "استكشف Web3",
      explore_desc: "أفضل التطبيقات اللامركزية بين يديك",
      browser_search_placeholder: "ابحث أو أدخل رابطاً...",
      discover: "اكتشف",
      bookmarks: "المفضلة",
      add_bookmark: "إضافة مفضلة",
      bookmark_name_placeholder: "الاسم",
      bookmark_url_placeholder: "الرابط",
      no_bookmarks_yet: "لا توجد مفضلة",
      portal_no_bookmarks_hint: "احفظ المواقع من المتصفح",
  ...
  en: {
    translation: {
      ...
      limit_order_unavailable_msg: 'Limit order service is currently unavailable. Do you want to execute at the current market price?',
      limit_price: 'Limit Price',
      below_market: 'Below market price',
      above_market: 'Above market price',
      place_limit_order: 'Place Limit Order',
      limit_order_placed: 'Limit order placed successfully',
      ...
      history_hint: "Visited sites will appear here",
      category_staking: "Staking",
      category_defi: "DeFi",
      category_trading: "Trading",
      category_pools: "Pools",
      explore_web3: "Explore Web3",
      explore_desc: "Best decentralized apps at your fingertips",
      ...
      portal_no_bookmarks_hint: "Save sites from the browser",
