...
const resources = {
  ar: {
    translation: {
      ...
      staking: {
        title: 'MECO Earn',
        vip_title: 'عضوية VIP الماسية',
        vip_description: 'خزن {{amount}} MECO واحصل على رسوم 0% على كل مبادلاتك!',
  ...
  en: {
    translation: {
      ...
      staking: {
        title: 'MECO Earn',
        vip_title: 'Diamond VIP Membership',
        vip_description: 'Stake {{amount}} MECO and get 0% fees on all your swaps!',
        ...
        stake_confirmation_message: 'Are you sure you want to stake {{val}} MECO in {{planName}} plan?',
        unstake_confirmation_message: 'Withdrawing {{val}} MECO may cause you to lose plan rewards. Confirm?',
        cancel: 'Cancel',
        confirm: 'Confirm',
        success: 'Success 🎉',
